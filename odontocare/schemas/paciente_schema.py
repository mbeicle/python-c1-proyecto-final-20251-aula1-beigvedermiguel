...
from odontocare.config import EstadoUsuario
...
class PacienteSchema(Schema):
    ...
    telefono = fields.String(required=True, allow_none=False, validate=validate.Length(min=3, max=25))
    estado = EnumField(EstadoUsuario, by_value=True, required=True, allow_none=False)
